...
// Another post
// Deployment: Another post

// === Enforcing pipeline use

// - GitHub allows preventing push to branch
// - IT also allows preventing merge until build passes

// WARNING: Requires "break glass" procedure for pushing changes to production in a hurry. Practically on GitHUb this
//          means administrators can skip protections
...
// - Simple & Clear
// - Fast!
// -- Needs to be so if there are emergencies it can be rolled out quickly
// -- Parallel; DAG.
// - Reliable!!
